...
`memc_sensfun`, and `memc_format_sensout`. This is a demonstration of
...
```{r}
sens_out <- memc_sensfun(config = MEND_config,
                          t = seq(0, 365),
...
```{r}
time <- 0:100
MENDsens_out <- memc_sensfun(config = MEND_config,
                              t = time,
                              x = c("V_d" = 3.0e+00,"K_d" = 0.250), 
                              sensvar = "DOM")

CORPSEsens_out <- memc_sensfun(config = CORPSE_config,
                                t = time,
                                x = c("V_d" = 3.0e+00,"K_d" = 0.250), 
                                sensvar = "DOM")
```
