...
Figures 1 and 2 are quite different from one another, let's focus on the DOC and IC pools in a side by side comparison. But first recall what is different between these two configurations. By taking a look at their configuration tables. It appears that these models differ in how the represent DOC uptake and POC decomposition. 
...
out1_to_compare <- out1[out1$variable %in% c("DOC", "IC"), ]
out2_to_compare <- out2[out2$variable %in% c("DOC", "IC"), ]
