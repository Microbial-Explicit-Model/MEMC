...
```{r}
comp_data <- memc_incubation$ultisol$data[c(1, 3)]
...
my_mod_config$state <- memc_incubation$ultisol$state
```
...
configurations listed in memc_all_models or created using configure_model
