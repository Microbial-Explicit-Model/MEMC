...
out1 <- memc_solve(mod = MEND_model, time = times)
out2 <- memc_solve(mod = COMISSION_model, time = times)
out3 <- memc_solve(mod = CORPSE_model, time = times)
out4 <- memc_solve(mod = MEMS_model, time = times)
out5 <- memc_solve(mod = BAMS_model, time = times)
out6 <- memc_solve(mod = MIMCS_model, time = times)
