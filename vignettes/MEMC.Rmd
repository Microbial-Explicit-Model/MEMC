...
included with the package or created using the `configure_model()`; and 
...
here for an example for how to use `configure_model` to build your own
SOM model.
...
```{r}
print(default_initial) # this is MEMC::default_initial
```
