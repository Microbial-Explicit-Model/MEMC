...
plot(result$time,result$D, type = "l",xlab = "Time (h)", ylab = "Concentration (mM)", lwd=3,col="#7f3b08")
```
...
Data<-read.csv("/Users/dorh012/Documents/2022/MEMC/Ultisol_control.csv",header=TRUE)
...
print(system.time(sR <- sensRange(func = solveLIN, parms = pars, dist ="norm",parMean=mean, parCovar=covar, sensvar = c("DOM", "POM","MOM","MB"), parRange = parRanges, num = 100)))
...
##
```{R plot}
pool<-read.csv("/Users/dorh012/Documents/2022/MEMC/Poolsize2.csv")
...
```{R plot}
pool<-read.csv("Users/dorh012/Documents/2022/MEMC/nutnet.csv")
