...
test_that("is_param_table works", {
  ...
  expect_error(is_param_table(params[1:10,]), "param_table is missing a parameter value(s) for: p.ep, p.em, r.ep, r.em, Q.max, K.ads, K.des, dd.beta, Input, CUE", fixed = TRUE)
